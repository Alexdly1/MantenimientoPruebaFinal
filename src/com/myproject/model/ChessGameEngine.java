...
import com.myproject.controller.ChessPanel;
import com.myproject.controller.BoardSquare;
...
public class ChessGameEngine{
    ...
    private void handleFirstClick(BoardSquare squareClicked, ChessGamePiece pieceOnSquare) {
        ...
        if (selectedPieceIsValid()) {
            ...
            String message = pieceOnSquare != null ? "You tried to pick up the other player's piece! Get some glasses and pick a valid square." : "You tried to pick up an empty square! Get some glasses and pick a valid square.";
